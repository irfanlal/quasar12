...
function change_og_image($og_image) {
    $og_image = 'https://quasar-ba.tempurl.host/wp-content/uploads/2023/11/quasar_d_o_o_logo.jpg';
    return $og_image;
}
add_filter('wpseo_opengraph_image', 'change_og_image');